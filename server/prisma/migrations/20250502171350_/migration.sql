/*
  ...
  - The values [INFRANT] on the enum `PassengerType` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "PassengerType_new" AS ENUM ('ADULT', 'CHILD', 'INFANT');
